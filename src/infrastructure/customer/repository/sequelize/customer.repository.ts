...
import CustomerRepositoryInterface from '../../../../domain/customer/repositoy/customer-repository.interface';
...
export default class CustomerRepository implements CustomerRepositoryInterface {
  ...
  async update(entity: Customer): Promise<void> {
    ...
    await CustomerModel.sequelize.transaction(
      this._updateCustomerTransaction(entity),
    );
  }
