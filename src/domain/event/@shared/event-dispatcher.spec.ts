...
import SendConsoleLogHandler from '../customer/handlers/send-console-log';
import SendConsoleLog1Handler from '../customer/handlers/send-console-log-1';
import SendConsoleLog2Handler from '../customer/handlers/send-console-log-2';
